...
//
// final LatestLaunchModel = launchModelFromJson(jsonString);

import 'dart:convert';

LatestLaunchModel latestLaunchModelFromJson(String str) =>
    LatestLaunchModel.fromJson(json.decode(str));

String launchModelToJson(LatestLaunchModel data) => json.encode(data.toJson());
